 ...
 */
public class ServerWindow extends FrameView {

   public ServerWindow(SingleFrameApplication app) {
      super(app);
    ...
    private void initComponents() {
        ...
        _mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, _mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(_mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(_indexScrollPane, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 544, Short.MAX_VALUE)
        ...
        _mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(_mainPanelLayout.createSequentialGroup()
                ...
                .addComponent(_indexScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        _menu.setName("_menu"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(kwic.ui.Main.class).getContext().getResourceMap(ServerWindow.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(kwic.ui.Main.class).getContext().getActionMap(ServerWindow.class, this);
        ...
        jButton1.setAction(actionMap.get("Shift")); // NOI18N
        ...
        _statusPanelLayout.setHorizontalGroup(
            ...
            .addGroup(_statusPanelLayout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addGroup(_statusPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(statusPanelSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 443, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, _statusPanelLayout.createSequentialGroup()
   ...
   public void Shift(){
       ...
       dlmtable = ((DefaultTableModel)_indexRecordList.getModel());
       dlmtable.setRowCount(0);
       ...
       //TODO: set dlmtable to _index
       /*for (Iterator<IndexedString> i = _index.iterator(); i.hasNext();){
           dlmtable.addRow(new Object[]{si.getIndex(), si.toString(), si.getURL()});
       }
       _indexRecordList.setModel(dlmtable);*/
   ...
   private DefaultTableModel dlmtable = null;
}
