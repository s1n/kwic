 ...
 */
public class ClientWindow extends FrameView {

   public ClientWindow(SingleFrameApplication app) {
      super(app);
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(kwic.ui.Main.class).getContext().getResourceMap(ClientWindow.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(kwic.ui.Main.class).getContext().getActionMap(ClientWindow.class, this);
